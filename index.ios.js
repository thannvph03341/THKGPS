          ...
          case 'hd_2':
              return (
                <View style={{flex: 1, flexDirection: 'column'}}>
                  ...
                  <View style={{ width: 50, height: 50, borderRadius: 25, borderColor: '#FFF', borderWidth: 3 , top: 25, left: 139 }}></View>
                  ...
                  <View style={{flex: 1,  flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                    ...
                    <View style={{ width: width, height: 200, flexDirection: 'row', justifyContent:'flex-end'}}>
                      <Text style={{ color:'#FFF', fontSize: 20,top: 80, fontWeight: 'bold',right: 0}}>Tốc độ!</Text>
                      <Image source = {muiTen1} style={{width: 64, height:39,top: 75, transform: [{rotate: '-90deg'}]}}/>
                      <View style={{ width: 50, height: 50, borderRadius: 25, borderColor: '#FFF', borderWidth: 3, right: 15, top: 65}}></View>
                    </View>
                </View>
              )
          case 'hd_4':
    ...
    if (this.state.loginSuccess) {
      return (
        <View style={{ flex: 1, backgroundColor: 'white', flexDirection: 'column', justifyContent: 'flex-start' }}>
          ...
          {this.state.chekHuongDan != null ? 
            <TouchableOpacity 
              style = {{width: width, height: height, position: 'absolute', zIndex:10, backgroundColor:'rgba(67, 66, 92, 0.6)'}}
              onPress = {() => {
                 AsyncStorage.getItem('huong_dan', (error, data) => {
            ...
            >
              ...
              {/*<Image source ={this.setupHuongDan(this.state.chekHuongDan)} style={{width: width, height: this.state.indexTabselector == 0 ? width:height, top:this.state.indexTabselector == 0 ? 28:0}}/>*/}
          ...
          */}
          ...
          <View style={{ width: width, flexDirection: 'column', position: 'absolute', zIndex: this.state.indexTabselector == 0 ? 1 : -1, marginTop: 25, alignItems: 'center' }}>
          ...
          <View style={{
            ...
            zIndex: this.state.indexTabselector == 1 ? 1 : 0, borderRadius: 25,
            bottom: 85, right: 15
          }}>
            <TouchableOpacity
        ...
        */}
          ...
          <View style={{
            ...
            zIndex: this.state.indexTabselector == 1 ? 1 : 0, borderRadius: 5,
            top: 25, left: 15
          }}>
            ...
            <View style={{ width: 178, height: 79, flexDirection: 'column', borderBottomLeftRadius: 5, borderBottomRightRadius: 5 }}>
              ...
              <View style={{ width: 178, height: 40, justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                <Text style={{ flex: 2, fontSize: 30, fontFamily: 'Quartz', textAlign: 'center', fontWeight:'bold'}}>{this.state.obectXeChay != null ? this.converTime(this.state.obectXeChay.Time):'00:00:00'}</Text>
                <TouchableOpacity 
           ...
           */}
          <View style={{ width: width, height: height - 75, backgroundColor: '#FFF', position: 'absolute', zIndex: this.state.isShowViewHanhTrinh ? 2 : -1, flexDirection: 'column', alignItems: 'center' }}>
            ...
            <View style={{ width: width - 2, height: height - 305, backgroundColor: '#43425C', marginTop: 1 }}>
          ...
          {/*Màn hình báo cáo*/}
           <View style={{ width: width, height: height - 75, backgroundColor: '#fff', position: 'absolute', zIndex: this.state.indexTabselector == 2 ? 2 : -10, flexDirection: 'column', alignItems: 'center' }}>
            <View style={{ width: width, height: 75, backgroundColor: '#43425C', flexDirection: 'row' }}>
            ...
            <View style={{ width: width - 2, height: height - 305, backgroundColor: '#fff', marginTop: 1 }}>
              {/*Danh sach hanh trinh*
               onEndReached = { () => this.phanTrangDulieuHanhTrinh()} //kéo đến hết listview sẽ load thêm dữ liệu
                onEndReachedThreshold = {5} // cách bên dưới 5 pixel
              */}
              <ListView style={{ flex: 1, margin: 0, backgroundColor:'#43425C' }}
                automaticallyAdjustContentInsets={false}
          ...
          * Màn hình tài khoản
          */}
          <View style={{ width: width, height: height - 75, backgroundColor: '#43425C', position: 'absolute', zIndex: this.state.indexTabselector == 3 ? 6 : -20, flexDirection: 'column', alignItems: 'center', borderBottomColor:'#FFF', borderBottomWidth:1 }}>
            <Image 
          ...
          */}
          <MapView
            ...
            style={{ flex: 1, backgroundColor: '#f3f3f3', flexDirection: 'row', justifyContent: 'center' }}
            initialRegion={
              {
          ...
          >
            ...
            {/*hiển thị lộ trình của xe*/}
              ...
              {this.state.obectXeChay != null ? this.state.indexTabselector == 1 ? <MapView.Marker
